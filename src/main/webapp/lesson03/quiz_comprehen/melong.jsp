...
<title>멜롱</title>
	...
	<style type="text/css">
		#wrap {height: 500px;}
		header {}
		#category {color: black; margin-right: 10px;}
		#image {margin: 10px 10px 10px 10px;}
		.artist-info {height: 120px; border: 1px solid green;}
	</style>
</head>
<body>
...
%>
			...
			<%
				...
				for(Map<String, Object> target : musicList){
					titleList.add(target.get("title").toString());
				}
				if(title == null){
			...
			%>
			<jsp:include page="song_info.jsp"></jsp:include>
