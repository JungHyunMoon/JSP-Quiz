...
<div class="artist-info d-flex">
	<img id="image" alt="아이유"
	...
	<table class="table table-sm text-center">
		...
		<tbody>
			...
			<tr>
				<td><%=music.get("id")%></td>
				<td><a
					href="/lesson03/quiz_comprehen/melong.jsp?title=<%=music.get("title")%>"><%=music.get("title")%></a></td>
